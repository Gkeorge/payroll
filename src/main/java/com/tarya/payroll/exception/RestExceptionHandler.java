...
import com.tarya.payroll.exception.apierror.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleEntityNotFound(EmployeeNotFoundException ex) {
    ...
    /**
     * Handle EmployeeEmailAlreadyExistsException
     */
    @ExceptionHandler(EmployeeEmailAlreadyExistsException.class)
    protected ResponseEntity<Object> handleEmailAlreadyExistsException(EmployeeEmailAlreadyExistsException ex) {
        ApiError apiError = new ApiError(NOT_FOUND);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
